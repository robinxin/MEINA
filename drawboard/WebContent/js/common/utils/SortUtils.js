...
common.utils.SortUtils = {
	/*Integer*/Compare_CH_Character:function(x,y){
		x = x == ""?"":this.getGB2312Spell(this.getFirstChar(x));
		y = y == ""?"":this.getGB2312Spell(this.getFirstChar(y));
		return this.compare(x,y);
	},
	//数字比较算法  
	/*Integer*/compare_number:function(x,y){  
	    var r="/[^d|.|-]/g";  
	    x=x.replace(r,"");  
	    y=y.replace(r,"");  
	    return this.compare(x*1,y*1);  
	},  
//	//时间比较算法  
//	/*Integer*/compare_date:function(x,y,isDesc){  
//	    var d='1900-01-01';  
...
//	},
	//英文字符串算法  
	/*Integer*/compare_en_character:function(x,y){  
	    x=this.getFirstChar(x);  
	    y=this.getFirstChar(y);  
	    return this.compare(x,y);  
	},
	/*String*/getFirstChar:function(s){
		if(s == "")return "";
		return (s + "").substr(0,1);
	},
	//取得汉字的拼音  
	/*String*/getGB2312Spell:function(str,sp){  
	    var i,c,t,p,ret="";  
	    if(sp==null)sp="";  
	    for(i=0;i<str.length;i++){  
	        if(str.charCodeAt(i)>=0x4e00){  
	            ...
	            if(p>-1&&p<3755){  
	                for(t=chSpell.length-1;t>0;t=t-2)if(chSpell[t]<=p)break;  
	                if(t>0)ret+=chSpell[t-1]+sp;  
	            }  
	        }  
	    }  
